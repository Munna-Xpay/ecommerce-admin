...
function TopProductsElectronics() {
  const categoryProducts=useSelector(state=>state.categoryReducer.categoryProducts)
  //console.log(categoryProducts);
  const electronics=categoryProducts.filter((i)=>i.category==='Electronics')
  ...
  return (
    ...
    >
      ...
      <SwiperSlide style={{padding:'25px'}}>            
        ...
        <Box border={1} borderColor={'#f1f1f1'} marginBottom={2}> <img width={170} height={130} src={product.thumbnail} alt="" /></Box> 
...
export default TopProductsElectronics