        ...
        <Paper sx={{ marginTop: '20px' }}>
            <Stack spacing={3} p={3}>
                <Stack alignItems={'start'} direction={'row'} justifyContent={'space-between'}>
                    <Stack>
                        <Typography variant='h5' sx={{ fontWeight: 'bold' }}>Total Report</Typography>
                        <Typography sx={{ opacity: '.8' }}>All Periods Per : {new Date(new Date().getFullYear(), 0, 1).toLocaleDateString()} - {new Date().toLocaleDateString()}</Typography>
                    </Stack>
                    <IconButton
                        id="basic-button"
                ...
                <Stack sx={{ border: '1px solid #e2e1e1', borderRadius: '10px', bgcolor: '#f9f9f9' }} alignItems={'center'} px={3} py={1} direction={'row'} spacing={2} justifyContent={'space-between'}>
                    <Stack direction={'row'} alignItems={'center'} spacing={1}>
                        <Box
                            component={'img'}
                            alt='icon'
                            src='https://shop-point.merku.love/assets/coins-c4361fe1.webp'
                            sx={{ width: '60px', height: '60px', objectFit: 'contain' }}
                        />
                        <Typography sx={{ fontWeight: 'bold' }}>Revenue</Typography>
                    </Stack>
                    <Typography sx={{ fontWeight: 'bold' }}>₹ <CountUp end={income} duration={1} /></Typography>
                    <Stack direction={'row'} alignItems={'center'} sx={{ color: 'green' }}>
                        <ArrowDropUpIcon />
                        <Typography sx={{ opacity: '.8', fontWeight: 'bold' }}>+ 35.10%</Typography>
                    </Stack>
                </Stack>
                <Stack sx={{ border: '1px solid #e2e1e1', borderRadius: '10px', bgcolor: '#f9f9f9' }} alignItems={'center'} px={3} py={1} direction={'row'} spacing={2} justifyContent={'space-between'}>
                    <Stack direction={'row'} alignItems={'center'} spacing={1}>
                ...
                <Stack sx={{ border: '1px solid #e2e1e1', borderRadius: '10px', bgcolor: '#f9f9f9' }} alignItems={'center'} px={3} py={1} direction={'row'} spacing={2} justifyContent={'space-between'}>
                    ...
                    <Stack direction={'row'} alignItems={'center'} sx={{ color: 'green' }}>
                        <ArrowDropUpIcon />
                        <Typography sx={{ opacity: '.8', fontWeight: 'bold' }}>+ 10.10%</Typography>
                    </Stack>
                </Stack>
                <Button variant='contained' size='large'>More Details</Button>
            </Stack>
        </Paper>
    )
}
